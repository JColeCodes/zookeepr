...
function filterByQuery(query, animalsArray) {
    ...
    // animalsArray as filteredResults:
    let filteredResults = animalsArray;

    if (query.personalityTraits) {
        // Save personalityTraits as a dedicated array
        // If personalityTraits is a string, place it into a new array ans save
        ...
        personalityTraitsArray.forEach(trait => {
            ...
            // It is initially a copu of animalsArray, but we're updating it for each trait in the forEach loop
